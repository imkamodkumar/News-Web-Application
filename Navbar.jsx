...
export default function Navbar() {
    ...
    return (
        <>
            <nav className="navbar navbar-expand-lg bg-body-tertiary background fs-5 sticky-top">
                <div className="container-fluid">
                    <Link className="navbar-brand text-ligh" to={`/language=${language}`}>NewsApp</Link>
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <form className="d-flex" role="search" onSubmit={(e) => postSearch(e)}>
                            <input className="form-control me-2" type="search" value={search} placeholder="Search" aria-label="Search" name='search' onChange={(e) => setSearch(e.target.value)} />
